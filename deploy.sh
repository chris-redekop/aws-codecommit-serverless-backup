...
scripts_s3_bucket="ca-central-1.code-commit-backup-scripts" # bucket must exist in the SAME region the deployment is taking place
backups_s3_bucket="backup.code-commit" # bucket must exist and have no policy that disallows PutObject from CodeBuild
